...
tcss.createAliases = function(identifiers) {
  var aliases = {classes: {}, ids: {}};
  var incr = 0;
  var radix = 36

  identifiers.classes.forEach(function(klass) {
    aliases.classes[klass] = "t" + incr.toString(radix);
    incr++;
  });

  identifiers.ids.forEach(function(id) {
    aliases.ids[id] = "t" + incr.toString(radix);
    incr++;
  });
